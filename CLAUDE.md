...
This file contains global development standards and guidelines that apply across all projects unless overridden by project-specific configuration files.

## Project Precedence

When project-specific files exist (AGENTS.md, CLAUDE.md, etc.), those rules override these global rules. Always check for project-specific configuration first.
...
- Code involving Dockerfiles, Kubernetes manifests, Terraform, TerragruntAnsible, etc.
