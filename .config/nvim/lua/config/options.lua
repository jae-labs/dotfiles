...
-- Conceal level
-- Controls how text with the "conceal" syntax attribute is shown.
-- 0 = show all text normally (nothing hidden)
-- LazyVim sets this to 2 by default, which hides markdown syntax like ``` and **
-- Default: 0
...
-- default auto-select avoids catastrophic backtracking and freezes in sh syntax highlighting during paging down
