...
# ---- Codeium Windsurf ----
# Adds Codeium Windsurf's bin directory to PATH for access to its CLI tools.
# Example: `surf` command becomes available in the terminal.
export PATH="/Users/luiz1361/.codeium/windsurf/bin:$PATH"
